...
# -*- coding: utf-8 -*-
"""
Created on Fri Jul 31 15:35:49 2020
...
def get_train_test(dataset):
    datafile = '/media/siyi/_dde_data/termB/projects/ourwork/deepwalk/example_graphs/'+dataset
    data = sio.loadmat(datafile)
    train_pos, train_neg, test_pos, test_neg = sample_neg(data['net'])
    return train_pos, train_neg, test_pos, test_neg